    ...
    def _setup_routes(self):
        ...
        async def run_test(request: TestRequest, background_tasks: BackgroundTasks):
            ...
            try:
                ...
                # 백그라운드에서 테스트 실행
                background_tasks.add_task(self._execute_test, test_id, request)
        ...
        async def run_distributed_test(
            request: TestRequest, background_tasks: BackgroundTasks
        ):
            """분산 테스트 실행"""
            try:
                ...
                background_tasks.add_task(
                    self._execute_distributed_test, test_id, request
                )
    ...
    async def _execute_distributed_test(self, test_id: str, request: TestRequest):
        ...
        try:
            ...
            if self.google_adk.cloud_storage_client:
                storage_path = await self.google_adk.upload_to_cloud_storage(
                    distributed_result
                )
