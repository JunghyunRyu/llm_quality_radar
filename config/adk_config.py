...
class ADKConfig:
    ...
    def __init__(self):
        ...
        self.playwright_mcp_args = os.getenv("PLAYWRIGHT_MCP_ARGS", "@playwright/mcp@latest").split(",")
        self.playwright_mcp_headless = os.getenv("PLAYWRIGHT_MCP_HEADLESS", "true").lower() == "true"
